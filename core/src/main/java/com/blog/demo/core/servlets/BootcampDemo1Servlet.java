...
import com.blog.demo.core.models.Employee;
...
@SlingServletPaths(value={"/8-"})
@ServiceDescription("Sample servlet to demonstrate crud operation")
public class BootcampDemo1Servlet extends SlingAllMethodsServlet { //SlingSafeMethodsServlet   SlingAllMethodsServlet
